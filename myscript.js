...
function updateGameArea() 
{
    ...
    if (myGameArea.frameNo == 1 || everyinterval(150)) {
        ...
        myObstacles.push(new component(55,63, "images/ballon1.png","images/ballon3.png", x, y,"image"));
    }
        ...
        if (myObstacles[i].crashWith(arrowl[j]))
         {
        	...
        	myObstacles[i].s1="images/splash.png";
        	myObstacles[i].width=84;
        	myObstacles[i].height=80;
        	myObstacles[i].s2="images/splash.png";
        	if(flag!=5)
        	{
        	score+=1;
        	myScore.s1="green";
